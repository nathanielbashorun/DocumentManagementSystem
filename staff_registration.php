<?php
//Admin registering staff to the system
session_start();
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>DMS | Register Staff</title>
    ...
    <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item">
            <label style="color:white">Hi - <?php echo $_SESSION['username'] ?><a class="nav-link" href="staff_registration.php?logout=true" style="color:white">Logout</a></label>
            </li>
          </ul>
              ...
              $('#submit').click(function(e){
                  ...
                  if(valid){
                      ...
                      $.ajax({
                          ...
                          data: {firstname: firstname,lastname: lastname,middlename: middlename,staff_id: staff_id},

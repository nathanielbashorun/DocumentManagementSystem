    ...
    <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item">
            <label style="color:white">Hi - <?php echo $_SESSION['username'] ?><a class="nav-link" href="cis_admin.php?logout=true" style="color:white">Logout</a></label>
          </li>
    ...
    <div class="container">
        ...
        <?php
          $sql = "
              ...
              WHERE course = 'Computer Information Systems' AND level = '".$_GET['id']."'
...
<script>
  $(document).ready(function(){
        load_cis_list();
        function load_cis_list()
        {
            var action = "fetch_cis";
            $.ajax({
                url: 'actionadmin.php',
                method: 'POST',
                data: {action:action},

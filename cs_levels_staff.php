...
<html lang="en">
  ...
  <body>
    <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item">
            <label style="color:white"><?php echo $_SESSION['staff_lastname']?> <?php echo $_SESSION['staff_firstname']?><a class="nav-link" href="cs_levels_staff.php?logout=true" style="color:white">Logout</a></label>
          </li>
    ...
    <div class="container">
        ...
        <div id="cs_table" class="table-responsive">
...
<script>
  $(document).ready(function(){
        load_levels_cs();
        function load_levels_cs()
        {
            var action = "fetch_levels_cs";
            $.ajax({
                url: 'actionstaff.php',
                method: 'POST',
                data: {action:action},

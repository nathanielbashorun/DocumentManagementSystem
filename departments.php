  ...
  <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item">
            <label style="color:white">Hi - <?php echo $_SESSION['username'] ?><a class="nav-link" href="departments.php?logout=true" style="color:white">Logout</a></label>
          </li>
    ...
    <div class="container">
        <a href="students_department.php" class="btn btn-success btn-lg">Students</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="staffs_department.php" class="btn btn-info btn-lg">Staffs</a>
    </div>    

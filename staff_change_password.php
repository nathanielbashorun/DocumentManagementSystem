    ...
    <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item">
            <label style="color:white"><?php echo $_SESSION['staff_lastname']?> <?php echo $_SESSION['staff_firstname']?><a class="nav-link" href="staff_change_password.php?logout=true" style="color:white">Logout</a></label>
          </li>
              ...
              $('#update').click(function(e){
                  ...
                  if(valid){
                    ...
                    var confirm_new_password = $('#confirm_new_password').val();
                      $.ajax({
                          type: 'POST',
                          url: 'staff_change_password_process.php',

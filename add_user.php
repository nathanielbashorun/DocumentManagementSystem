...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>DMS | Register New User</title>
  ...
  <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item">
            <label style="color:white">Hi - <?php echo $_SESSION['username'] ?><a class="nav-link" href="add_user.php?logout=true" style="color:white">Logout</a></label>
          </li>
    ...
    <div class="container">
        <a href="student_registration.php" class="btn btn-success btn-lg">Register Student</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="staff_registration.php" class="btn btn-info btn-lg">Register Staff</a>
    </div>    

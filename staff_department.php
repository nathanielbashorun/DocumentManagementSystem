...
<html lang="en">
  ...
  <body>
    <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item">
            <label style="color:white"><?php echo $_SESSION['staff_lastname']?> <?php echo $_SESSION['staff_firstname']?><a class="nav-link" href="staff_department.php?logout=true" style="color:white">Logout</a></label>
          </li>
    ...
    <div class="container">
        ...
        <div id="departments_table" class="table-responsive">
